...
const AddMember = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.name == "") {
            ...
            try {
                ...
                setTimeout(async () => {
                    const { data } = await axios.post(`${API_URL}/api/about_as`, formData);
                    console.log(data);
    ...
    return (
        <Fragment>
            <AdminPageTitle activePage="Add About us" pageName="About us" />

            <div className="d-flex col-xl-10 row-lg-12" >
                <div className="card" >
                    <div className="card-header">
                        <h4 className="card-title">ADD About us</h4>
                    </div>
