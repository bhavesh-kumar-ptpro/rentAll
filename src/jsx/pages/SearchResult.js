...
const SearchResult = () => {
    ...
    if(plantype == "Individual "){
        plantype = query.get("planType")+"&"+" Family"
    }
console.log(plantype);

    let staticdata = {
        localGovt: query.get("localGovt") || "",
                ...
                <div className={styles["container"]}>
                    <div className={cx(styles["row"], styles["inner_contaniner"])}>
                        <div className={styles["left_section"]}>
                            ...
                            <div className={styles["left-nav"]}>
                                <ul>
                                    ...
                                    <li className="active"><a className={cx(styles["sb-toggle-submenu"], styles["sb-caret2"])} href="javascript:void(0);">Monthly Cost <i className="icon-caret"></i></a>
                        ...
                        <div className={cx(styles["middil_section"], styles["search-result-box"])}>
                            <h2 style={{ color: "#00a65a" }}>Search Result</h2>
