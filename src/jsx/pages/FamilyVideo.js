        ...
        <Row className={cx(styles["main-section"], styles["home-section-1"])}>
          ...
          <Col md={6}>
            <div className=" p-3 ">
              ...
              {searchdata.video_url ? (<iframe width="560"
                height="315"
                style={{ marginTop: "100px", marginLeft: "50px" }}
                src={`${API_URL}/public/video/Company_video/` + searchdata.video_url}
                title="naija Insurance" >
              </iframe>) : <h3 style={{ marginTop: "100px", marginLeft: "50px" }}>Video is not available</h3>}
