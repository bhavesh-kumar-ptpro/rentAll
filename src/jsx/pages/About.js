          ...
          {/* <div className={styles["admin-blck"]}>
            ...
            <div className={styles["admin-content"]}>
              <div className={styles["admin-img"]}>
                <img src="http://naijamedical.com.ng/images/ceo1.png" alt="ceo" />
              </div>
...
{memberData && memberData.map((el)=>{
  return(
    <div className={styles["admin-blck"]}>
    <div className={styles["admin-title"]}>
      <h4>{el.name} - <span>{el.designation}</span></h4>
      <h5>{el.company_name}</h5>
    </div>
    <div className={styles["admin-content"]}>
      <div className={styles["admin-img"]}>
        <img style={{width:"200px",height:"200px",objectFit:"cover",borderRadius:"50%"}} src={`${API_URL}/public/image/Company_Logo/${el.memberPhoto}`} alt="ceo" />
      </div>
      <div className={styles["about-list"]} dangerouslySetInnerHTML={{__html:el.description}}>
        {/* <ul>
          ...
          {/* <div className={styles["admin-blck"]}>
            ...
            <div className={styles["admin-content"]}>
              <div className={styles["admin-img"]}>
                <img src="http://naijamedical.com.ng/images/director1.png" alt="ceo" />
              </div>
              <div className={styles["about-list"]}>
                <ul>
                  <li>Damola is a Registered Nurse, Home health at the Calvary Health Group, Houston Texas, USA </li>
